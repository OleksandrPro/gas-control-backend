...
from inventory_system.schemas import Card, CardFilter, PaginatedResponse, PipeLengthStats
...
class ICardRepository(Protocol):
    ...
    async def get_pipes_length_sum(self, filter_params: CardFilter) -> PipeLengthStats: ...
